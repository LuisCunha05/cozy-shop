const headerLoginRegistroComponente = () => {
    return `
    <header class="header">
            <img src="../images/logo.svg" alt="Logo" class="header-image">
            <div class="header-buttons">
                <a href="home.html" class="header-button">Home</a>
                <a href="produtos.html" class="header-button">Produtos</a>
                <a href="editar_produtos.html" class="header-button">Editar Produtos</a>
...
export default headerLoginRegistroComponente;